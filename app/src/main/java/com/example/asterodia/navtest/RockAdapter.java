...
/**
 * Created by Asterodia on 17/07/2016.
...
public class RockAdapter extends BaseExpandableListAdapter {

    private Context context;
    private LayoutInflater inflater;
    private ArrayList<RockParent> mParent;

    public RockAdapter(Context _context, ArrayList<RockParent> parent){
        mParent = parent;
        context = _context;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup viewGroup) {
        ...
        Rock child = mParent.get(groupPosition).getChild();
